...
from rsris.models.models import RefSegEncoderDecoder, RefSegResNetVisionModel, RefSegSiglipTextModel, RefSegSamVisionEncoder, RefSegSamPromptEncoder, RefSegSamMaskDecoder
...
model = dict(
    ...
    # ),
    clip_vision_encoder=dict(
        type=RefSegResNetVisionModel,
        model_name_or_path="microsoft/resnet-50",
        local_ckpt_path="./model_cache/models/microsoft/resnet-50/rsp-resnet-50-ckpt.pth",
    ),
    clip_text_encoder=dict(
