...
from rsris.models.models import RefSegEncoderDecoder, RefSegSiglipVisionModel, RefSegBertTextModel, RefSegSamVisionEncoder, RefSegSamPromptEncoder, RefSegSamMaskDecoder
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # 'clip_text_encoder.projection': dict(lr_mult=10.0),
        }
    ),
