"""
    基于预处理后的特征（视觉手工提取特征 + word2vec特征）进行 SVM 分类
...
def train_and_evaluate_svm():
    ...
    """
        ...
        分类报告:
                   ...
                   0       0.79      0.83      0.81      1600
                   1       0.56      0.57      0.57       914
                   2       0.64      0.59      0.62      1270
        
            accuracy                           0.69      3784
           macro avg       0.66      0.66      0.66      3784
        weighted avg       0.68      0.69      0.68      3784
    ...
    # --- 1. 路径配置 ---
    data_input_path = "./process_data/02-make-train-val-test-dataset"
